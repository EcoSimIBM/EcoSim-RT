...
private:
	...
	//int reprodFailedA;					//-- Age of parents in the failure of Reproduction RS
	...
	//int reproduceFailedAsexual;			//Number of reproduce asexual fails
	//float reproduceFailedAsexualRatio;	//Ratio of reproduce asexual fails
