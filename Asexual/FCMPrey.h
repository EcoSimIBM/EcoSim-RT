...
public:
	...
	********/
	...
	const static int ReproduceAsexual							= 41;	//RS
	...
	const static int NbActions		    = 21; //RS
	...
	const static int ReproduceAsexualAction				= 14;	//RS
	const static int ReproduceAsexualFailAction			= 15;
	...
	********/
	...
	const static int ReproduceAsexual							= 35;	//RS
...
//	const static int Decision 			= 26;
	...
	const static int NbActions			= 17;				//RS
	...
	const static int ReproduceAsexualAction				= 10; 	//RS
	const static int ReproduceAsexualFailAction			= 11; 	//RS
