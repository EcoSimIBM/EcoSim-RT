...
void Stat::writeStat(Ecosystem * eco) {
	...
	statFile << ", " << (nbActionPreyMale.at(FCMPrey::ReproduceAsexualAction - 1) > 0 ? Manip.vtos(avgEnergyTransferredMalePrey / (float)(nbActionPreyMale.at(FCMPrey::ReproduceAsexualAction - 1))) : Manip.vtos(0));
	...
	statFile << ", " << (nbActionPreyFemale.at(FCMPrey::ReproduceAsexualAction - 1) > 0 ? Manip.vtos(avgEnergyTransferredFemalePrey / (float)(nbActionPreyFemale.at(FCMPrey::ReproduceAsexualAction - 1))) : Manip.vtos(0));
