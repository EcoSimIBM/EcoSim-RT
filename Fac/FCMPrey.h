...
public:
	...
	********/
	...
	const static int ReproduceAsexual							= 42;	//RS
	const static int Move2StrongestPrey							= 43;	//A.G
	const static int Move2StrongestPreyCell						= 44;	//A.G
	const static int Move2WeakestPreyCell						= 45;	//A.G
	//const static int Decision 			= 32;

	const static int NbActions		    = 23; //RS
	...
	const static int ReproduceAsexualAction				= 16;	//RS
	const static int ReproduceAsexualFailAction			= 17;
	const static int Move2StrongestPreyAction			= 18;	//A.G
	const static int Move2StrongestPreyFailAction		= 19;	//A.G
	const static int Move2StrongestPreyCellAction		= 20;	//A.G
	const static int Move2StrongestPreyCellFailAction	= 21;	//A.G
	const static int Move2WeakestPreyCellAction			= 22;	//A.G
	const static int Move2WeakestPreyCellFailAction		= 23;	//A.G
	...
	********/
	...
	const static int ReproduceAsexual							= 36;	//RS
	const static int Move2StrongestPrey							= 37;	//A.G
	const static int Move2StrongestPreyCell						= 38;	//A.G
	const static int Move2WeakestPreyCell						= 39;	//A.G
//	const static int Decision 			= 26;

	const static int NbActions			= 19;				//RS
	...
	const static int ReproduceAsexualAction				= 12; 	//RS
	const static int ReproduceAsexualFailAction			= 13; 	//RS
	const static int Move2StrongestPreyAction			= 14;	//A.G
	const static int Move2StrongestPreyFailAction		= 15;	//A.G
	const static int Move2StrongestPreyCellAction		= 16;	//A.G
	const static int Move2StrongestPreyCellFailAction	= 17;	//A.G
	const static int Move2WeakestPreyCellAction			= 18;	//A.G
	const static int Move2WeakestPreyCellFailAction		= 19;	//A.G
