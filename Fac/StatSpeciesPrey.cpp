...
void StatSpeciesPrey::write_Header(string Prey, string PreyFCM, int gen) {
	...
	if ((gen == 1) || ((gen % 1000) == 0)) {
		...
		statFile << ", reprodFailed_age, reprodFailed_energy, reproduceAsexualFailedCount, reproduceAsexualFailedRatio";
		...
		statFile << ", concept_escape, concept_searchFood, concept_searchFood2, concept_socialize, concept_exploration, concept_wait, concept_eat, concept_eat2, concept_reproduce, concept_reproduceAsexual";	//RS
#else
		...
		statFile << ", concept_fear, concept_hunger, concept_searchPartner, concept_curiosity, concept_sedentary, concept_satisfaction, concept_nuisance";
		statFile << ", concept_escape, concept_searchFood, concept_socialize, concept_exploration, concept_wait, concept_eat, concept_reproduce, concept_reproduceAsexual, concept_move2StrongestPrey, concept_move2StrongestPreyCell, concept_move2WeakestPreyCell\n";	//RS
#endif
